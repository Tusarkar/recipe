(function () {
  ...
  function openOrderModal() {
    ...
    syncScrollLock();
    var t = document.getElementById("orderModalTitle");
    if (t) {
      t.focus();
    }
  }
  ...
  function syncScrollLock() {
    var locked =
      !modal.hidden || (orderModal && !orderModal.hidden);
  ...
  if (orderModal) {
    orderModal.querySelectorAll("[data-close-order]").forEach(function (el) {
